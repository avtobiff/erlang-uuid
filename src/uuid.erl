...
-spec uuid3(NamespaceOrUuid::atom() | uuid_string() | uuid(),
            Name::string()) -> uuid().
uuid3(dns,  Name) -> byname(md5, <<16#6ba7b8109dad11d180b400c04fd430c8:128>>, Name);
uuid3(url,  Name) -> byname(md5, <<16#6ba7b8119dad11d180b400c04fd430c8:128>>, Name);
uuid3(oid,  Name) -> byname(md5, <<16#6ba7b8129dad11d180b400c04fd430c8:128>>, Name);
uuid3(x500, Name) -> byname(md5, <<16#6ba7b8149dad11d180b400c04fd430c8:128>>, Name);
uuid3(nil,  Name) -> byname(md5, <<0:128>>, Name);
uuid3(UuidStr, Name) when is_list(UuidStr) -> byname(md5, to_binary(UuidStr), Name);
uuid3(UuidBin, Name) when is_binary(UuidBin) -> byname(md5, UuidBin, Name);
...
-spec uuid5(NamespaceOrUuid::atom() | uuid_string() | uuid(),
            Name::string()) -> uuid().
uuid5(dns,  N) -> byname(sha1, <<16#6ba7b8109dad11d180b400c04fd430c8:128>>, N);
uuid5(url,  N) -> byname(sha1, <<16#6ba7b8119dad11d180b400c04fd430c8:128>>, N);
uuid5(oid,  N) -> byname(sha1, <<16#6ba7b8129dad11d180b400c04fd430c8:128>>, N);
uuid5(x500, N) -> byname(sha1, <<16#6ba7b8149dad11d180b400c04fd430c8:128>>, N);
uuid5(nil,  N) -> byname(sha1, <<0:128>>, N);
uuid5(UuidStr, N) when is_list(UuidStr) -> byname(sha1, to_binary(UuidStr), N);
uuid5(UuidBin, N) when is_binary(UuidBin) -> byname(sha1, UuidBin, N);
...
%%       respectively.
-spec byname(HashFunction::md5 | sha1, Prefix::binary(), Name::string()) -> uuid().
byname(md5, Prefix, Name) ->
    NameBin = list_to_binary(Name),
    compose_namebased_uuid(?UUIDv3, crypto:md5(<<Prefix/binary,NameBin/binary>>));
byname(sha1, Prefix, Name) ->
    NameBin = list_to_binary(Name),
